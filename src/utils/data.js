...
export const project = {
  ...
  tagline_long: "Yoon Wi Ubbi Buntu Koom, Nga xam sa bopp, Mën sa bopp",
  logo: "abslogo_black.svg",
  socials: [
    {name: 'facebook', short:'',  link:'https://bit.ly/ABSfacebook'},
    {name: 'twitter', short:'',  link:'https://bit.ly/ABStwitter'},
    {name: 'youtube', short:'',  link:'https://bit.ly/ABSyoutube'},
    {name: 'instagram', short:'',  link:'https://bit.ly/ABSinstagram'},
  ],
  credits:  `Designed & Dev by' ${lawwd.logo}`,
  copyright: '© 2024, Abdoulaye SYLLA / ABS2024, all rights reserved',
} 
