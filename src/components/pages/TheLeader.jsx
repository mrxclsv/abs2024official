      ...
      <div className='z-[2] flexV start w-full relative'>
        ...
        <div id="Slides" className='flexV center overflow-hidden bg-white z-[1] w-sceen'>
          ...
          <div className='splitText flexV w-screen center bg-gradient-to-b from-blakk to-neutral-900'>
            ...
            <div className='flexV lg:max-w-7xl justify-between lg:flex-row px-10 py-10'>
          ...
          <SplitDiv title="Empowering the disabled" color="white" link=""
            ...
            showLines={false}
            layout={1}
            mainCSS="overflow-hidden min-h-[50vh] lg:max-w-7xl lg:max-h-[800px] my-20= rounded-lg overflow-hidden"
            blockCSS="h-full"
            css="group "
          ...
          <div className='splitText flexV lg:flex-row px-6 lg:px-0 lg:max-w-7xl py-10'>
          ...
          <div className="&TheCommunity h-full lg:h-fit w-screen flexV lg:flex center relative bg-blakk">
            ...
            <div className='flexV lg:flex-row center w-full lg:h-[80vh] relative lg:max-w-7xl'>
              <AndTheCommunity />
            </div>
