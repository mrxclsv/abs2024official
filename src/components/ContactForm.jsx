...
const ContactForm = ({ css, simplified }) => {
  ...
  return (
    <div className={`w-full lg:w-1/2 bg-gray-100 py-8 ${simplified && '!w-fit !lg:w-full !self-start !py-0 !bg-transparent'} flex center`}>
      <form
        className="Form flexV fit items-start justify-center bg-gray-100 shrink-0  text-black lg:lg:max-w-7xl rounded-lg p-8 pb-16 lg:pb-8 m-auto gap-4"
        onSubmit={sendEmail}>
